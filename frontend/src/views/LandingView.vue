    ...
    <section class="bg-[#14213d] text-white py-20 px-4">
      <div class="max-w-4xl mx-auto text-center">
        ...
        <p class="text-xl md:text-2xl text-[#e5e5e5] mb-8">
          Create stunning e-invitations for weddings, birthdays, and parties.
        </p>
        <a
          href="/host/login"
      ...
      <div class="max-w-6xl mx-auto">
        ...
        <div class="grid md:grid-cols-3 gap-8">
          <div class="bg-white p-6 rounded-lg shadow-sm text-center">
            <div class="w-16 h-16 bg-[#fca311] rounded-full flex items-center justify-center mx-auto mb-4">
